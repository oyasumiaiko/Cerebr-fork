  ...
  const PREDEFINED_THEMES = [
    ...
    },
    {
      ...
      variables: {
        ...
        '--cerebr-text-color': '#cccccc',
        '--cerebr-message-user-bg': 'rgba(15, 15, 15, var(--cerebr-opacity))',
        '--cerebr-message-ai-bg': 'rgba(10, 10, 10, var(--cerebr-opacity))',
        '--cerebr-input-bg': 'rgba(5, 5, 5, var(--cerebr-opacity))',
